...
Revision ID: 059bd3b2efa1
Revises: 97913352ec80
Create Date: 2023-08-07 00:55:22.152335
...
revision = '059bd3b2efa1'
down_revision = '97913352ec80'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.UniqueConstraint('given_question')
    )
    op.drop_table('cues')
...
def downgrade():
    ...
    sa.UniqueConstraint('given_question', name='user_answer_given_question_key')
    )
